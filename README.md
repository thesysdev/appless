...
<p align="center">
  <a href="https://openui.com">
    <img src="./assets/banner.png" alt="applessOS" width="100%" />
  </a>
</p>

<h1 align="center">applessOS &middot; a phone with no apps. just ask.</h1>
...
<p align="center">
  <a href="https://openui.com"><b>Built on OpenUI</b></a> &nbsp;&middot;&nbsp;
  <a href="https://openui.com">openui.com</a> &nbsp;&middot;&nbsp;
  <a href="https://github.com/thesysdev/openui">OpenUI on GitHub</a> &nbsp;&middot;&nbsp;
...
You open applessOS and ask for what you want, and the screen for it is generated
...
```
ui/contract.tsx  ->  system prompt  ->  Cerebras LLM  ->  openui-lang  ->  <Renderer>  ->  native UI
   (one contract)     (generated)       (streaming)       (the DSL)       (react-lang)    (Cupertino / Material)
```
...
applessOS is a thin, native shell over the OpenUI runtime. The heavy lifting is
the OpenUI stack:
...
applessOS is one of many things you can build on OpenUI. To use the same
